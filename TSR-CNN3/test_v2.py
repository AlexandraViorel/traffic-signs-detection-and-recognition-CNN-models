...
# model = load_model('D:\Faculty materials\BACHELORS-THESIS\TSR-CNN3\TSRNet3Original\models\comic-sweep-6.h5')

# # Load or define your test data (X_test and y_test)
# # X_test should be the test images, and y_test should be the corresponding labels

# X_test, y_test = load_test_dataset()

# # Assuming y_test is one-hot encoded, convert it back to categorical labels
