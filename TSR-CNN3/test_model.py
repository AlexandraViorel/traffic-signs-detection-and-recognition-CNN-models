...
BS=32
sign_labels = open("D:\Faculty materials\BACHELORS-THESIS\BelgianAndGermanSigns.csv").read().strip().split("\n")[1:]
sign_labels = [l.split(",")[1] for l in sign_labels]

x_test, y_test = load_test_dataset()
print(y_test)
print(f"Number of target names: {len(sign_labels)}")

models_directory = "TSRNet3Original\models"
